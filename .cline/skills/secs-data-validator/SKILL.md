...
**Important**: When generating any code or text files as output, always save them in the `demo/` subdirectory at the project root, organized into appropriate subdirectories by file type:
...
5. If generating corrected files or examples, save to appropriate `demo/` subdirectories
...
4. Save any corrected versions or analysis output to `demo/` subdirectories
...
```
Save any processed log files, extracted SML, or analysis output to `demo/logs/` or `demo/reports/` subdirectories.
